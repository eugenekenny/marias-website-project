        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6 w-full py-32 flex flex-col md:flex-row items-center gap-12">
          ...
          <div className="flex-1 text-center md:text-left">
            <p className="animate-fadeInUp delay-100 text-[#C9A84C] uppercase tracking-widest text-sm font-semibold mb-4">
              Denver &amp; Surrounding Areas · Century 21 Moore Team
            </p>
        ...
        <div className="max-w-6xl mx-auto px-6 flex flex-col md:flex-row gap-16 items-center">
          <ScrollReveal className="flex-1">
            ...
            <p className="text-gray-600 text-lg leading-relaxed mb-8">
              Now with Century 21 Moore Team, Maria brings the same trusted, personal
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              { icon: "⭐", title: "Century 21 Moore Team", desc: "All the personal service of a local agent, backed by the Moore Real Estate team and one of the world's most trusted real estate brands." },
            ].map((card, i) => (
      ...
      <footer className="bg-[#1a2744] text-blue-200 py-12">
        <div className="max-w-6xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-4 text-sm">
          <div>
            ...
            <div className="text-[#C9A84C] text-xs uppercase tracking-widest">Century 21 Moore Team · Denver, CO</div>
          </div>
