...
# Colors matching Maria's website
...
def make_header():
    """Create the navy header block."""
    header_data = [[Paragraph("Maria's Website", title_style)],
...
# Intro line
intro = ParagraphStyle('intro', parent=styles['Normal'], fontSize=10,
                        textColor=MID_GRAY, alignment=TA_CENTER, fontName='Helvetica-Oblique')
story.append(Paragraph("Keep this document somewhere safe — it has everything you need to manage Maria's website.", intro))
story.append(Spacer(1, 16))
...
story += make_section("🚀", "Vercel — Website Hosting", [
    ...
    ("Live Site", "marias-website-project.vercel.app"),
])
...
story += make_section("📬", "Formspree — Contact Form", [
    ...
    ("Form ID", "xpqkezor"),
    ("Leads Go To", "kenlssiter@gmail.com"),
])
...
story += make_section("📧", "Gmail — Maria's Email", [
    ("What it is", "Where you forward good leads to Maria"),
